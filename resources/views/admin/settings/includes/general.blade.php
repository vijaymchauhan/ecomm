    ...
    <form action="{{ route('admin.settings.update') }}" method="POST" role="form">
        ...
        <div class="tile-body">
            <div class="form-group">
                ...
                <input class="form-control" type="text" placeholder="Enter site name" id="site_name" name="site_name"
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" placeholder="Enter store currency code" id="currency_code"
