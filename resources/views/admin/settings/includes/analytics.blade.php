    ...
    <form action="{{ route('admin.settings.update') }}" method="POST" role="form">
        ...
        <div class="tile-body">
            <div class="form-group">
                ...
                <textarea class="form-control" rows="4" placeholder="Enter google analytics code" id="google_analytics"
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" rows="4" placeholder="Enter facebook pixel code" id="facebook_pixels"
